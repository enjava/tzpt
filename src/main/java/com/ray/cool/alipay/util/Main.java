package com.ray.cool.alipay.util;
...
public class Main {
	...
	public void test_monitor_pos() {
		...
		AlipayHeartbeatSynRequestBuilder builder = new AlipayHeartbeatSynRequestBuilder().setProduct(Product.FP)
				.setType(Type.SOFT_POS).setEquipmentId("soft100001")
	...
	public void test_trade_pay(AlipayTradeService service) {
		...
		AlipayTradePayRequestBuilder builder = new AlipayTradePayRequestBuilder().setAppAuthToken(appAuthToken)
