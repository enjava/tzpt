...
<body>
    <div class="page">
  	  <img src="{:$var_x['path']['tem_dir_url']:}/images/action/201512/yingchungou/01.jpg" />
      <img src="{:$var_x['path']['tem_dir_url']:}/images/action/201512/yingchungou/02.jpg" />
      <img src="{:$var_x['path']['tem_dir_url']:}/images/action/201512/yingchungou/03.jpg" border="0" usemap="#Map" />
      <map name="Map">
        <area shape="rect" coords="171,1,573,111" href="{:$var_x['path']['mleroot_url']:}/mobile/prod_class_1117.php">
      </map>
      <img src="{:$var_x['path']['tem_dir_url']:}/images/action/201512/yingchungou/04.jpg"/>
      <img src="{:$var_x['path']['tem_dir_url']:}/images/action/201512/yingchungou/05.jpg" border="0" usemap="#Map2"/>
      <map name="Map2">
      ...
      <img src="{:$var_x['path']['tem_dir_url']:}/images/action/201512/yingchungou/06.jpg"  />
    </div>
