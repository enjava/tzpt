...
.h_tit{padding:20px 0; text-align:center; font-size:16px; color:#f00;}

.dhb{width:50%; max-width:200px; margin:0 auto; position:relative;}
...
<div class="h_tit">亲，不错哦，你累计摇到{:$mle['mem_other_data']['red_packet_money']:}元红包</div>



<div class="dhb"><img src="{:$var_x['path']['tem_dir_url']:}/images/dhb.png" /><span>{:$mle['mem_other_data']['red_packet_money']:}</span></div>
...
<div class="btn">
	...
	<ul>
    	...
    	<li>邀请好友要红包<a href="http://www.zmly.cc/?prod_id=12" style="color:#e2002e; background:url({:$var_x['path']['tem_dir_url']:}/images/yqbtn.png) no-repeat; background-size:100% 100%;">邀请好友</a></li>

        <li>微信秒结 0.5元即可提现 <a href="input_take_kickback_info_ofwx.php" style="color:#fff; background:url({:$var_x['path']['tem_dir_url']:}/images/txbtn.png) no-repeat; background-size:100% 100%;">立刻提现</a></li>
	...
	<ul>
		...
		{:foreach $mle['red_packet_list'] as $red_packet_value:}
	    	...
	    	<li>
	        	...
	        	{:date('Y-m-d', $red_packet_value['addtime']):}
