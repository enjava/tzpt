...
<div class="h_tit">亲，不错哦，你摇到{:$mle['red_packet_data']['money']:}元红包</div>

<div class="dhb"><img src="{:$var_x['path']['tem_dir_url']:}/images/dhb.png" /><span>{:$mle['red_packet_data']['money']:}</span></div>

<div class="btn">
	<ul>
    	<li>邀请好友要红包<a href="{:$var_x['path']['mleroot_url']:}" style="color:#e2002e; background:url({:$var_x['path']['tem_dir_url']:}/images/yqbtn.png) no-repeat; background-size:100% 100%;">邀请好友</a></li>
        <li>马上去购物<a href="input_take_kickback_info_ofwx.php" style="color:#fff; background:url({:$var_x['path']['tem_dir_url']:}/images/txbtn.png) no-repeat; background-size:100% 100%;">立刻提现</a></li>
