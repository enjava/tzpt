...
var redirect_uri = 'http://tougao.kagirl.net/kawa_callback.php';                     
...
function goto_kawa()
{
    if(kawa_data.modify == 'yes' || kawa_data.replace_modify == 'yes')
    {
        ...
        location.href = 'http://mp.weixin.qq.com/s?__biz=MzA3NzIxODU5NQ==&mid=203209870&idx=1&sn=281f0df01afc402a3660be367c8e4cfc#wechat_redirect';
    }
    else
    {
...
function popup_note()
{
    ...
    note.style.cssText = "visibility:visible;position:absolute;background-image:url('images/audio_widget_01@2x.png');width:15px;height:25px";
