...
.pro img{vertical-align:bottom; width:100%;}
</style>
</head>

<body>

<div class="pro_img" style="margin-bottom:60px;">
	...
	<img src="{:$var_x['path']['tem_dir_url']:}/images/image/{:if $mle['mem_data']['cost_money']==0:}11.jpg{:else:}11.jpg{:/if:}" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/22.jpg" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/33.jpg" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/44.jpg" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/55.jpg" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/66.jpg" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/77.jpg" />
    </a>
</div>
<a href="{:if $mle['mem_data']['subscribe_time']==0:}{:$var_x['config']['weixin']['subscribe_url']:}{:else:}{:$var_x['path']['mleroot_url']:}/mobile/detail.php?product_id={:$mle['par']['prod_id']:}{:/if:}">
