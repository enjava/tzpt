...
<div class="pro_img" style="margin-bottom:60px;">
	...
	<img src="{:$var_x['path']['tem_dir_url']:}/images/image/{:if $mle['mem_data']['cost_money']==0:}1.jpg{:else:}1.jpg{:/if:}" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/2.jpg" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/3.jpg" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/4.jpg" />
    <img src="{:$var_x['path']['tem_dir_url']:}/images/image/5.jpg" />
    </a>
</div>
<a href="{:if $mle['mem_data']['subscribe_time']==0:}{:$var_x['config']['weixin']['subscribe_url']:}{:else:}{:$var_x['path']['mleroot_url']:}/mobile/detail.php?product_id={:$mle['par']['prod_id']:}{:/if:}">
