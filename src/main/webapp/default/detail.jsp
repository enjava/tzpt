...
<title>{:$mle['product_data']['title']:} - 创富商盟</title>
{:include file="detail_wx_share.tpl":}{:*微信api初始化有延迟，优先加载*:}
...
<link href="{:$var_x['path']['tem_dir_url']:}/style/slider_1.css" rel="stylesheet" />
...
.cart_num{position:absolute; width:40px; height:40px; top:10px; left:10px; border:1px solid #ccc; border-radius:3px; background:url({:$var_x['path']['tem_dir_url']:}/images/cart_ico.png) center center no-repeat;}
...
<div class="pro_t">
	<ul>
    	<li style="border-bottom:1px solid #ced3d7; position:relative;"">
        	<h3>{:$mle['product_data']['title']:}</h3>
        	{:if $smarty.get.pagetype == 'iframe':}{:* 在iframe框架中显示 *:}share_qr_img
        	...
        	{:/if:}
        	<img style="width:19px; height:19px;" src="{:$var_x['path']['tem_dir_url']:}/images/commom/share.png" />
        	<br /><span>分享</span>
        	</a>
        	<a onclick="click_collect_a({:$mle['product_data']['id']:});" href="javascript:void(0);" class="sc" >
        	<img style="width:19px; height:19px;" id="colltect_status_img" src="{:$var_x['path']['tem_dir_url']:}/images/{:if $mle['is_collect_prod'] == true:}sc_active.png{:else:}sc.png{:/if:}" no_collect_src="{:$var_x['path']['tem_dir_url']:}/images/sc.png"  collect_src="{:$var_x['path']['tem_dir_url']:}/images/sc_active.png"   is_collect="{:if $mle['is_collect_prod'] == true:}1{:else:}0{:/if:} "/>
        	<br /><span id="colltect_status_text">{:if $mle['is_collect_prod'] == true:}已收藏{:else:}收藏{:/if:}</span>
        	</a>
            <div class="price">
            ...
            <p><!-- 快递&nbsp;&nbsp;免运费 -->&nbsp;&nbsp;<label>销量&nbsp;&nbsp;{:$mle['product_data']['sold_num']:}件</label></p>
        </li>
        <li>
        	<table cellpadding="0" cellspacing="0">
            	<tr>
                    ...
                    <td>(剩余{:if $mle['product_data']['stock']<=0:} 0（库存不足，无法购买）{:else:}{:$mle['product_data']['stock']:}{:/if:})</td>
                </tr>
            </table>
        </li>
    </ul>
...
<div class="pro_con">
	...
	{:if $smarty.get.pagetype == 'iframe':}{:* 在iframe框架中显示 *:}
    ...
    <div style="padding:10px; font-size:14px; line-height:22px;">
        <div id="con_menu_1" style="display:none" class="hover">
          <p>商品货号：<span>{:$mle['product_data']['art_no']:}</span></p>
          <p>所属品牌：<span>{:$mle['product_data']['join_m_brand']['title']:}</span></p>
          <p>商品规格：<span>{:$mle['product_data']['specification']:}</span></p>
        </div>
        ...
        <div id="con_menu_3">
	        ...
	        <script type="text/javascript">
				function chg(id_num){ 
					...
					if(oa.style.display == "block"){ 
						...
						oc.src = "{:$var_x['path']['tem_dir_url']:}/images/comment_sub1.png";
					}else{ 
						oa.style.display = "block"; 
						oc.src = "{:$var_x['path']['tem_dir_url']:}/images/comment_sub2.png";
					} 
				}
			</script>
        	<!--<center>暂无评价！</center>-->
            ...
            <div class="com">
                <div class="c_title" onClick="return chg('test1');" style="cursor:pointer;">
                    我要评论
                    <a href="javascript:void(0);" id="test1_a"><img id="test1_img" style="width:22px; float:right; padding-top:7px;" src="{:$var_x['path']['tem_dir_url']:}/images/comment_sub2.png" /></a>
                    <br class="clear" />
                </div>
...
{:if $smarty.get.pagetype != 'iframe':}{:* 在iframe框架中不显示 *:}
<div class="buy_box" >
<!-- 
