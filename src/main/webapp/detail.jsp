...
<%@include file="WEB-INF/view/jsp/commons/detail_wx_share.jsp"%><%--{:include file="detail_wx_share.tpl":}<%--{:*微信api初始化有延迟，优先加载*:}--%>
    ...
    <div id="slider_1" class="slider_1_wrap">
        <ul >
	        <%--{:foreach $mle['product_data']['picture'] as $picture:}--%>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/a.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/b.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/c.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/d.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/e.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/f.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/g.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/h.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/i.jpg" />
                </li>
                <li>
                    <img src="${pageContext.request.contextPath}/image/product/j.jpg" />
                </li>
	        <%--{:/foreach:}--%>
        </ul>
